...
private readonly ServiceConfig config;
        ...
        public DoWork(ServiceConfig config, IAuthenticator authenticator = null, ILogger<IntegrationService> logger = null)
        {
            this.config = config;
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            Console.WriteLine("Ensured Data Lake File System");
